...
export const experience = [
  {
    ...
    stack: [
      "React", "Next.js", "NestJS", "PostgreSQL", "Prisma ORM",
      "Redis", "Stripe", "Twilio", "Postmark", "Keycloak",
      "Cloudflare", "Docker", "Linux", "CI/CD",
    ],
  },
  {
    ...
    stack: [
      "React", "Next.js", "NestJS", "PostgreSQL", "TypeORM",
      "BullMQ", "Firestore", "Stripe", "AWS", "Docker",
  ...
  },
  {
    ...
    stack: [
      "React", "Next.js", "Gatsby", "NestJS", "GraphQL",
      "PostgreSQL", "Sequelize", "Ruby on Rails", "Heroku",
    ],
  },
  {
    ...
    stack: ["JavaScript", "React", "Java", "Spring Boot", "PostgreSQL", "Docker", "GitLab CI/CD"],
  },
];
...
export const skills: Record<string, string[]> = {
  ...
  "DevOps & Cloud": ["AWS", "Docker", "Linux", "pm2", "Heroku", "CI/CD", "Bitbucket Pipelines", "Cloudflare"],
